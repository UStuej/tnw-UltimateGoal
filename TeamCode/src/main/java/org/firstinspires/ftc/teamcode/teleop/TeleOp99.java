...
public class TeleOp99 extends OpMode {
    ...
    private static double LIFT_POWER_MULTIPLIER = 0.35;  // The value multiplied to lift motor values to prevent snapping the line. Currently set to 35% of full power
