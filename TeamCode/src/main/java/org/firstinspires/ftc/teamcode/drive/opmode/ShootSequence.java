...
public class ShootSequence extends OpMode {
    ...
    private final double RING_FINGER_IN_POSITION = 0.05;
    private final double RING_FINGER_OUT_POSITION = 0.65;
    ...
    public void init() {
        ...
        RING_ELEVATOR_UP_POSITION = RING_ELEVATOR_DOWN_POSITION + 2080;
