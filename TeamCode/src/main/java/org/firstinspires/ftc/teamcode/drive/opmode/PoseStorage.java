...
public class PoseStorage {
    ...
    public static Pose2d powerShot1Pose = new Pose2d(0, -4);
    public static Pose2d powerShot2Pose = new Pose2d(0, -12);
    public static Pose2d powerShot3Pose = new Pose2d(0, -20);
    public static Pose2d highGoalShootPose = new Pose2d();
}